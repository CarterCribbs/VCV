...
days_ago_start = 1831 #put "10" for ten days ago
days_ago_end = 6 #put "1" for yesterday 


s=Service('/Users/cartercribbs/Downloads/Driver/chromedriver')
driver = webdriver.Chrome(service=s)
url='http://www.energyonline.com/Data/GenericData.aspx?DataId=9&MISO___Day-Ahead_Energy_Price'
driver.get(url)
